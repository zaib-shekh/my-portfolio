    ...
    <div className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white py-10">
      <div className="container mx-auto px-4">
        ...
        <div className="relative">
          <div className="border-r-2 border-blue-700 dark:border-blue-700 absolute h-full top-0" style={{ left: '50%' }}></div>
          {ExperienceData.map((experience, index) => (
            <div key={index} className={`mb-8 flex justify-between items-center w-full ${index % 2 === 0 ? 'flex-row-reverse' : ''}`}>
              ...
              <div className="border border-blue-900 dark:bg-slate-900 p-4 rounded hover:bg-gray-100 dark:hover:bg-slate-800 relative shadow-lg shadow-slate-500/50 order-1 bg-gray-200 w-5/12 px-6 py-4" style={{ height: 'auto' }}>
